...
public class UpdateCheckk extends JFrame implements ActionListener
{
    Choice ccustomer;
    JTextField tfroom,tfname,tfcheckin,tfpaid,tfpend;
    ...
    UpdateCheckk() 
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("update.jpg"));
